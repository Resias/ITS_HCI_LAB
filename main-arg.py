...
def processing_log(src_path, out_path):
...
def main():
    ...
    parser.add_argument("--src", required=True, help="입력 TXT 파일 폴더 경로")
    parser.add_argument("--out", required=True, help="출력 Parquet 파일 폴더 경로")
